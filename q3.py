...
# Funkcia na získanie hranice ceny zo vstupu od užívateľa
...
def main(directory):
    ...
    hladana_cena = get_price_threshold()
...
# Spustenie hlavného programu s adresárom, kde sú uložené súbory
if __name__ == "__main__":
    directory = 'C:/Users/Ucitel/Desktop/QR_KODY'  # Zmeňte na skutočnú cestu k adresáru
    main(directory)
